-- Alpha version of my Win11Lib Fork - See https://v3rmillion.net/showthread.php?tid=1141954 for the original.
local Win11Lib = {}
Win11Lib.Version = 1;
Win11Lib.tabs = {}
Win11Lib.tabs.funcs = {}
...
Win11Lib.createMenu = function(
  name, bind, menuButtons, sizeX, sizeY, usericonId, userIconText, userIconSubText
 )
  if sizeX < 800 then sizeX = 800 end
  if sizeY < 500 then sizeY = 500 end
  ...
  UIS.InputBegan:Connect(
    function( key, gp )
      if key.KeyCode == bind then mainOutline.Visible = not mainOutline.Visible end
    end
  )

  -- ANCHOR menu button shit
  if menuButtons == true then
    ...
    -- close button shit
    buttonClose.MouseEnter:Connect(
      function()
    ...
    buttonClose.MouseLeave:Connect(
      function()
        bottomCover.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
        sideCover.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
        buttonClose.ImageColor3 = Color3.fromRGB(32, 32, 32)
    ...
    buttonClose.MouseButton1Down:Connect(
      function()
    ...
    buttonClose.MouseButton1Click:Connect(function() container.Parent = nil end)

    -- fullscreen button shit
    buttonFullScreen.MouseEnter:Connect(
      function()
    ...
    buttonFullScreen.MouseLeave:Connect(
      function()
        buttonFullScreen.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
        square.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
        square.BorderColor3 = Color3.fromRGB(105, 105, 105)
    ...
    buttonFullScreen.MouseButton1Down:Connect(
      function()
        buttonFullScreen.BackgroundColor3 = Color3.fromRGB(48, 48, 48)
        square.BackgroundColor3 = Color3.fromRGB(48, 48, 48)
      end
    )
    buttonFullScreen.MouseButton1Click:Connect(
      function()
        if topBar.Size.X.Offset ~=
          game:GetService('Workspace').CurrentCamera.ViewportSize.X then
          topBar.Position = UDim2.new(0, 0, 0, 0)
          topBar.Size = UDim2.new(
            0, game:GetService('Workspace').CurrentCamera.ViewportSize.X, 0, 27
          )
          mainOutline.Size = UDim2.new(
            1, 0, 0, game:GetService('Workspace').CurrentCamera.ViewportSize.Y
          )
        else
    ...
    buttonMinimize.MouseEnter:Connect(
      function()
    ...
    buttonMinimize.MouseLeave:Connect(
      function()
        buttonMinimize.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
    ...
    buttonMinimize.MouseButton1Down:Connect(
      function()
        buttonMinimize.BackgroundColor3 = Color3.fromRGB(48, 48, 48)
        line.BackgroundColor3 = Color3.fromRGB(48, 48, 48)
      end
    )
    buttonMinimize.MouseButton1Click:Connect(function() mainOutline.Visible = false end)
  end
  ...
  mouse.Move:Connect(
    function()
      if isResize then
        ...
        if (mouse.X - topBar.AbsolutePosition.X) >= 800 and
          (mouse.Y - topBar.AbsolutePosition.Y) >= 500 then
          topBar.Size = UDim2.new(0, (mouse.X - topBar.AbsolutePosition.X) + 9, 0, 27)
          mainOutline.Size = UDim2.new(1, 0, 0, (mouse.Y - topBar.AbsolutePosition.Y) + 9)
        end
      end
  ...
  icon.Image = game.Players:GetUserThumbnailAsync(
    game.Players.LocalPlayer.UserId, Enum.ThumbnailType.HeadShot,
  ...
  menu.addTab = function( text, flag, enabled, iconId )
    local SettingsPrefix = Win11Lib.slib.KeyNamePrefix .. 'tabs.' .. text .. '-' .. flag;
    ...
    if defaultTab then
      Win11Lib.tabs[flag] = enabled
    else
      Win11Lib.tabs[flag] = false
    end
    ...
    if Win11Lib.tabs[flag] == false then tabButton.ImageTransparency = 1 end
    ...
    options.addButton = function( text, descText, func )
      ...
      settingContainer.CanvasSize = settingContainer.CanvasSize + UDim2.new(0, 0, 0, 71)
      ...
      button_2.MouseEnter:Connect(
        function() button_2.Frame.ImageColor3 = Color3.fromRGB(63, 63, 63) end
      )

      button_2.MouseLeave:Connect(
        function() button_2.Frame.ImageColor3 = Color3.fromRGB(55, 55, 55) end
      )

      button_2.MouseButton1Down:Connect(
        function() button_2.Frame.ImageColor3 = Color3.fromRGB(73, 73, 73) end
      )

      button_2.MouseButton1Up:Connect(
        function() button_2.Frame.ImageColor3 = Color3.fromRGB(63, 63, 63) end
      )
    ...
    options.addSlider = function(
      ...
      slider_2.MouseButton1Down:Connect(
        function()
      ...
      slider_2.bar.circle.MouseButton1Down:Connect(
        function()
          slider_2.bar.Size = UDim2.new(0, (mouse.X - slider_2.AbsolutePosition.X), 1, 0)
          isDown = true
        end
      ...
      mouse.Move:Connect(
        function()
          if precise then
            ...
            value = math.floor(
              (slider_2.bar.Size.X.Offset / slider_2.AbsoluteSize.X) * range
            ) + min
          end
          if isDown then
            ...
            elseif mouse.X > (slider_2.AbsolutePosition.X + slider_2.AbsoluteSize.X) then
              ...
              slider_2.bar.Size = UDim2.new(
                0, (mouse.X - slider_2.AbsolutePosition.X), 1, 0
              )
            end
      ...
      slider_2.bar.Size = UDim2.new(
        0, ((defaultValue / range) * slider_2.AbsoluteSize.X), 1, 0
      )
      func(defaultValue)
    end
    ...
    options.addDropdown = function( text, descText )
      ...
      dropdownBody.MouseButton1Click:Connect(
        function()
          toggle = not toggle
          if toggle and (#dropdownBody.sectionContainer:GetChildren() - 1) > -1 then
            dropdownBody.chevron.Rotation = 90
            dropdown.Size = UDim2.new(
              1, 0, 0, ((#dropdownBody.sectionContainer:GetChildren() - 1) * 57) + 80
            )
            settingContainer.CanvasSize = UDim2.new(
              0, 0, 0,
              ((settingContainer.CanvasSize.Y.Offset + dropdown.Size.Y.Offset) - 69)
            )
          else
      ...
      dropdownOptions.addOption = function( name, flag, defaultValue, func )
        ...
        if func then callFunctionToggle = true end
        ...
        local function updateValue()
          ...
          if Win11Lib.flags.dropdownToggles[flag] then
            ...
            optionContainer.disabledCircle.innerCircle.ImageColor3 = Color3.fromRGB(
              0, 0, 0
            )
      ...
      dropdownOptions.clear = function()
        for i, v in pairs(sectionContainer:GetChildren()) do
          if v:IsA('TextButton') then v.Parent = nil end
        end
        ...
        if toggle and (#dropdownBody.sectionContainer:GetChildren() - 1) > -1 then
          ...
          dropdownBody.chevron.Rotation = 0
          settingContainer.CanvasSize = UDim2.new(
            0, 0, 0, (settingContainer.CanvasSize.Y.Offset - dropdown.Size.Y.Offset) + 69
          )
          dropdown.Size = UDim2.new(1, 0, 0, 70)
        end
      end
      ...
      dropdownOptions.remove = function( flag )
        ...
        for i, v in pairs(Win11Lib.flags.dropdownToggles) do
          ...
          if i == flag then break end
        end

        if #sectionContainer:GetChildren() == 2 then flagIndex = flagIndex + 1 end
    ...
    options.addToggle = function( text, flag, descText, defaultValue, func )
      ...
      local function toggleF()
        ...
        if Win11Lib.flags.toggles[flag] then
          ...
          parent.ImageColor3 = Color3.fromRGB(
            (accentColor.R - 48), (accentColor.G - 48), (accentColor.B - 48)
          )
